	...
	void history()
	{
		...
		if(isInternetPresent) {
			...
			if (user == null && user == "") {
				...
				//	Toast.makeText(this, "Please enter FindX ID", Toast.LENGTH_SHORT).show();
				Snackbar.make(findViewById(android.R.id.content), "Please enter FindX ID", Snackbar.LENGTH_LONG)
						.setAction("Ok", snackaction)
                        .setActionTextColor(Color.WHITE)
                        .show();
