...
public class FriendLocation extends ActionBarActivity implements FragmentDrawer.FragmentDrawerListener, android.location.LocationListener, OnCameraChangeListener, OnMapLoadedCallback {
    ...
    protected void onStop() {
        ...
        FindX.MIN_TIME_BW_UPDATES = 1000 * 60 * 10;
    ...
    protected void onResume() {
        ...
        if (FindX.mRunning) {
            ...
            context.startService(new Intent(context, FindX.class));
        }
        ...
        FindX.MIN_TIME_BW_UPDATES = 1000 * 60 * 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, "Hi! Locate me using FindX app" + "\n" + "\n" + "FindX ID :" + "\n" + mystringuername + "\n" + "\n" + "\n" + "To access location live, download FindX on google play" + "\n" + "https://play.google.com/store/apps/details?id=" + context.getPackageName() + "\n\n" + "Or access the location online at" + "\n" + "www.skylinelabs.in/FindX" + "\n\n" + "Shared via FindX");
                startActivity(Intent.createChooser(sharingIntent, "Send FindX ID"));
            }
...
/***************************************************************************************************************/
    ...
    void search() {
        ...
        if (isInternetPresent) {
            ...
            if (!first && !second && !third && !fourth) {
                //  Toast.makeText(getApplicationContext(), "Currently FindX can track only 4 friend", Toast.LENGTH_SHORT).show();
                Snackbar.make(findViewById(android.R.id.content), "Currently FindX can track only 4 friend", Snackbar.LENGTH_LONG)
                        .setAction("Ok", snackaction)
                        .setActionTextColor(Color.WHITE)
                        .show();
