...
public class Privacypolicy extends ActionBarActivity implements FragmentDrawer.FragmentDrawerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wb.loadUrl("http://www.skylinelabs.in/FindX/privacy/");
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 7:
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "FindX feedback");
                intent.putExtra(Intent.EXTRA_TEXT, "Hi ! It was an awesome experience using FindX! ");
