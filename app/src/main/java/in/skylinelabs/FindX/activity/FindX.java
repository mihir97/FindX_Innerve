...
public class FindX extends Service implements android.location.LocationListener
{
    ...
    public static long MIN_TIME_BW_UPDATES = 1000 * 60 * 10; // 10 minutes
    ...
    public void stopUsingGPS()
    {
        ...
        {
            locationManager.removeUpdates(FindX.this);
        }
    }
...
/**************************************************GeoFence******************************************************/
    ...
    public void onProviderDisabled(String provider) {
        ...
        mBuilder.setContentTitle("FindX Disconnected");
...
// notificationID allows you to update the notification later on.
    ...
    public void onDestroy() {
        super.onDestroy();
        startService(new Intent(this, FindX.class));
        mRunning = false;
    }
...
// notificationID allows you to update the notification later on.
    ...
    public void runFindX()
    {
        ...
        //Toast.makeText(this,"FindX background service started",Toast.LENGTH_SHORT).show();
